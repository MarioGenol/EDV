...
import {
  ...
  class CanvasJSStockChart implements AfterViewInit, OnChanges, OnDestroy {
	...
	constructor() {
	  ...
	  this.stockChartContainerId =
		'canvasjs-angular-stockchart-container-' +
		CanvasJSStockChart._cjsStockChartContainerId++;
	}
	...
	ngAfterViewInit() {
	  ...
	  // Next line is commented to fix the problem of loading empty chart before loading data
	  //this.stockChart.render();
	  this.prevStockChartOptions = this.options;
